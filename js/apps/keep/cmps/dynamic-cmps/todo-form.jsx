        ...
        return (
            <form className="note-add" onSubmit={this.props.onSaveNote}>
                ...
                <div className="input-header">
                    ...
                    <input type="text" id="noteHeader" value={noteHeader} onChange={(ev) => { this.props.handleChange(ev) }} />
                </div>
                <div className="input-comment">
                    <label htmlFor="comment" >Comment</label>
                    <input type="text" id="comment" value={comment} onChange={(ev) => { this.props.handleChange(ev) }} />
                </div>
                <label htmlFor="todoTxt" ><i className="far fa-check-square"></i></label>
                <div className="todo-input-cont">
                    <input id="todoTxt" type="text" placeholder="Enter comma seperated list..." value={todoTxt}
